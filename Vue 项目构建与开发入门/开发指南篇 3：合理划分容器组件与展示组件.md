...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/8/13/16533670555c3f00~tplv-t2oaga2asx-jj-mark:1512:0:0:0:q75.png?w=478&h=364&f=png&s=19662)
...
![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/8/14/165387907893eb84~tplv-t2oaga2asx-jj-mark:1512:0:0:0:q75.png?w=633&h=41&f=png&s=9420)

可见组件的层次越深数据传递的过程就会变得越复杂，当然这取决于你如何划分容器组件和展示组件，比如我们可以将上述博客首页换一种划分方式：

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/8/14/1653884e4abef22f~tplv-t2oaga2asx-jj-mark:1512:0:0:0:q75.png?w=298&h=364&f=png&s=10718)

上图我们页面中存在 3 个容器组件，每个容器组件又可以包含各自的展示组件，这样一定程度上可以减少组件的层次嵌套深度。当然展示组件中也可以包含对应的容器组件来解决数据传输的问题：

![](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2018/8/14/165388d3df0a32c5~tplv-t2oaga2asx-jj-mark:1512:0:0:0:q75.png?w=633&h=41&f=png&s=10187)
